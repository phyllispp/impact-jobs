...
def parse_location(location_text: str) -> Location:
    ...
    # Jobstreet locations can be "Singapore", "Hong Kong", "Singapore, Central", etc.
    parts = location_text.split(",")
    city = parts[0].strip()
    
    # Determine country based on city
    country = Country.SINGAPORE
    if "hong kong" in city.lower() or "hk" in city.lower():
        country = Country.HONGKONG
    elif "singapore" in city.lower() or "sg" in city.lower():
        country = Country.SINGAPORE
